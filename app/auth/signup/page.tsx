      ...
      <div className="flex justify-center py-8 px-4">
        <form action="" className="w-[500px] bg-[#151515] rounded-lg p-8 mt-4">
          ...
          <div className="flex flex-col items-center justify-center w-full mt-4 ">
            ...
            <Link href={'/auth/login'} className="align-center text-center text-[18px] font-bold transition-all duration-300 text-[#fff] bg-indigo-700 opacity-45 hover:opacity-100 w-full rounded-md py-4 ">
              Daxil ol
            </Link>
          </div>
        </form>
